...
const Footer = () => {
  return (
    <footer className="bg-dark-subtle h-100 pb-5">
      <div className="container d-flex flex-wrap justify-content-between align-items-center py-3 mt-4 border-top">

        <p className="col-md-4 mb-0 text-body-secondary text-start">© 2025 Company, Inc</p>


        <Link to='/' className="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none fw-bold text-body">E-COMMERCE</Link>
